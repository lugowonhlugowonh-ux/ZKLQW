...
-- // LOADING SCREEN ELEGANT (KOTAK TENGAH & SHIMMER)
do
...
local Window = AtherLibrary:Window({
    Name = '<font color="rgb(175, 102, 126)">luzor.</font>hub',
...
CompatScreenGui.Name = "luzor_whitelist_ui"
